...
--
-- Máquina: localhost
-- Data de Criação: 31-Jan-2014 às 01:50
...
CREATE TABLE IF NOT EXISTS `Disciplina` (
  ...
  KEY `fk_Disciplina_Credito1_idx` (`Credito_idCredito`)
...
ALTER TABLE `Disciplina`
  ADD CONSTRAINT `fk_Disciplina_Credito` FOREIGN KEY (`Credito_idCredito`) REFERENCES `Credito` (`idCredito`) ON DELETE NO ACTION ON UPDATE NO ACTION;
